...
exports.getCycles = exports.createAttachments = exports.getPriorityValues = exports.getTeamsTemplate = exports.getTeams = exports.getMe = exports.updateAnIssue = exports.createAnIssue = exports.createALabel = exports.searchAnIssue = void 0;
...
const createAnIssue = (variables, token) => __awaiter(void 0, void 0, void 0, function* () {
    const query = `
...
const getCycles = ({ token }) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield fetch(url, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
...
//# sourceMappingURL=linear%20copy.js.map
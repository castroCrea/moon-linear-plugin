...
export declare const createAnIssue: (variables: IssueCreate, token: string) => Promise<false | IssueSuccess>;
...
export type States = Record<'backlog' | 'unstarted' | 'started' | 'completed' | 'canceled', State[]>;
...
type CycleNode = Cycle & {
    team: {
        id: string;
    };
};
export declare const getCycles: ({ token }: {
    token: string;
}) => Promise<CycleNode[]>;
export {};
